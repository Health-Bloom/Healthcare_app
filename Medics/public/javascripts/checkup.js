...
.then(data=>{
    ...
    p1.innerHTML=(data.data.balanced.protein).toFixed(2)+" gms";
    f1.innerHTML=(data.data.balanced.fat).toFixed(2)+ " gms";
    c1.innerHTML=(data.data.balanced.carbs).toFixed(2)+ " gms";
...
var c2=document.querySelector('.hcarbs');
   ...
   .then(data=>{
       console.log(data);
       p2.innerHTML=(data.data.highprotein.protein).toFixed(2)+" gms";
       f2.innerHTML=(data.data.highprotein.fat).toFixed(2)+ " gms";
       c2.innerHTML=(data.data.highprotein.carbs).toFixed(2)+ " gms";
   })
...
var c3=document.querySelector('.lfcarbs');
   ...
   .then(data=>{
       console.log(data);
       p3.innerHTML=(data.data.lowfat.protein).toFixed(2)+" gms";
       f3.innerHTML=(data.data.lowfat.fat).toFixed(2)+ " gms";
       c3.innerHTML=(data.data.lowfat.carbs).toFixed(2)+ " gms";
   })
